...
vec2.__index    = vec2
vec2.__tostring = vec2.to_string
function vec2.__call(_, x, y) return vec2.new(x, y) end
function vec2.__unm(a) return new(-a.x, -a.y) end
function vec2.__eq(a, b) if not vec2.is_vec2(a) or not vec2.is_vec2(b) then return false end return a.x == b.x and a.y == b.y end
